    ...
    <div>    <div className={styles.FooterP}>
      <div className={styles.boxFoot}>
        ...
        <p>
          ...
          could be handpicked and delivered to your home, all at the click of a
          button? India’s first comprehensive online megastore, bigbasket.com,
          brings a whopping 20000+ products with more than 1000 brands, to over
          4 million happy customers. From household cleaning products to beauty
          and makeup, bigbasket has everything you need for your daily needs.
        ...
        <p>
          ...
          Our On-time Guarantee is one such assurance where we refund 10% of the
          bill value if the delivery is delayed. For all your order values above
          Rs. 1000, we provide free delivery. A wide range of imported and
          gourmet products are available through our express delivery and
          slotted delivery service. If you ever find an item missing on delivery
          or want to return a product, you can report it to us within 48 hours
        ...
        <p>
          ...
          <span>beverages</span> that include cool drinks, hot teas, fruit
          juices and more.
        </p>
        <p>
      ...
      <div className={styles.FootLinks}>
        ...
        <div>
          ...
          <img
            src="https://www.bbassets.com/static/v2580/custPage/build/content/img/Google-App-store-icon.png"
            alt="play store"
          />
          <img
            src="https://www.bbassets.com/static/v2580/custPage/build/content/img/Apple-App-store-icon.png"
            alt="app store"
          />
        </div>
        <div>
      ...
      <div className={styles.FootLinks2}>
        <div>
